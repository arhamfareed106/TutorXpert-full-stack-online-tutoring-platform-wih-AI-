    ...
    <div>
      ...
      <div className="mt-8 p-4 bg-neutral-50 rounded-xl">
        ...
        <div className="text-sm text-neutral-600 space-y-1">
          <p><strong>Learner:</strong> student@example.com / learner123</p>
          <p><strong>Tutor:</strong> sarah.johnson@tutorxpert.com / tutor123</p>
          <p><strong>Admin:</strong> admin@tutorxpert.com / admin123</p>
        </div>
      </div>
    </div>
  );
