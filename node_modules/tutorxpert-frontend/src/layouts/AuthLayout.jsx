      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-primary items-center justify-center p-12">
        <div className="max-w-md text-white">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold font-display">TutorXpert</span>
          </div>
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            Learn with expert tutors
          </h1>
          <p className="text-xl text-white/80 mb-8">
            Connect with personalized tutors who match your learning style, goals, and schedule.
          </p>
          <div className="flex gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-12 h-12 rounded-full border-2 border-white/30 bg-white/20"
            ...
            <div className="flex flex-col justify-center">
              ...
              <span className="text-white/80 text-sm">10,000+ happy learners</span>
            </div>
          </div>
        </div>
      </div>
